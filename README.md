...
For general users, here is the link (https://www.mristudio.org)<br>
   **for JHU-BME students:** get DtiStudio_64_Apr_2019.exe and sample data from ([https://forms.office.com/r/cUu10713gw]). Put them under C: drive. <br>
...
3. **Open DtiStudio.exe on your Windows PC. You can simply double-click the file.**<br>
